// Author: Nimish Doshi: Modified Version of Original WebLogic QueueSend Example.
...
public class QueueSend
{
  ...
  */
  public static void main(String[] args) throws Exception {
    if (args.length != 2) {
      System.out.println("Usage: java examples.jms.queue.QueueSend WebLogicURL ConnFactory");
      return;
    }
    JMS_FACTORY = args[1];
